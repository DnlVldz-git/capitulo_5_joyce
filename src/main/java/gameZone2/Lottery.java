...
public class Lottery {
    public static void main(String[] args) {
        ...
        System.out.println("Introduzca el primer número de su jugada:");
        int n1 = read.nextInt();
        System.out.println("Introduzca el segundo número de su jugada:");
        int n2 = read.nextInt();
        System.out.println("Introduzca el tercer número de su jugada");
        int n3 = read.nextInt();
